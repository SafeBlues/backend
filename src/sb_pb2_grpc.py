...
class SafeBluesAdminStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NewStrand = channel.unary_unary(
                '/safeblues.SafeBluesAdmin/NewStrand',
...
def add_SafeBluesAdminServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'safeblues.SafeBluesAdmin', rpc_method_handlers)
...
class SafeBluesAdmin(object):
    ...
    def NewStrand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safeblues.SafeBluesAdmin/NewStrand',
...
def add_SafeBluesServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'safeblues.SafeBlues', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class SafeBlues(object):
    ...
    def PingServer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safeblues.SafeBlues/PingServer',
    ...
    def Report(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safeblues.SafeBlues/Report',
    ...
    def Pull(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safeblues.SafeBlues/Pull',
